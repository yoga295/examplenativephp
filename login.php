                    ...
                    <div class="card rounded-3 text-black">
                        <div class="card-body p-md-5 mx-md-4">
                            <div class="text-center">
                                <img src="6301.jpg" style="width: 185px;" alt="logo">
                            ...
                            <form action="aksi_login.php" method="POST">
                                ...
                                <div class="text-center pt-1 mb-5 pb-1">
                                    <a href="pasien.php"></a><button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" name="submit" type="submit">Log in</button>
                                </div>
